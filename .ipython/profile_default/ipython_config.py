...
# The name of a Pygments style to use for syntax highlighting:  xcode, autumn,
# perldoc, bw, vim, pastie, friendly, tango, algol, fruity, colorful, lovelace,
# monokai, manni, algol_nu, paraiso-dark, borland, rrt, default, emacs, trac,
# vs, paraiso-light, igor, murphy, native
